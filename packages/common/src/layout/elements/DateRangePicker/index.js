        ...
        <DateRangePickerStyle className={addAllClasses.join(' ')}>
          <label>
            ...
            {/* <DateRangePicker
              ...
              startDateId={startDateId} // PropTypes.string,
              endDate={endDate} // momentPropTypes.momentObj or null,
              endDateId={endDateId} // PropTypes.string,
              onDatesChange={onDateChangeFunc} // PropTypes.func,
              focusedInput={focusedInput} // PropTypes.oneOf([START_DATE, END_DATE]) or null,
              onFocusChange={onFocusChangeFunc} // PropTypes.func,
            /> */}
            <div>
              <div />
            </div>

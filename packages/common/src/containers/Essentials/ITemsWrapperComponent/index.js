      ...
      <FeatureSectionWrapper style={{ padding: '0' }}>
        {items.map(item => {
          return (
            <Link
              href="/store"
              // onClick={() => handleMenuModal(item, restaurant, currency)}
            ...
            >
              <ImageContainer>
                <Image
                  className="images"
                  layout="fill"
                  src={`https://r.cdn.ayazona.com/${item.image}`}
                  alt={item.name}
                />
              </ImageContainer>
              <Text
              ...
              />
              <Text className="header" content={item.name} />
              <Text className="info" content={item.description} />

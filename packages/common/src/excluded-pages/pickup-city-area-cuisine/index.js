    ...
    <ThemeProvider theme={appTheme}>
      <>
        <Head>
          ...
          <link
            rel="canonical"
            href={`https://www.ayazona.com/pickup/${city.toLocaleLowerCase()}/${location
              .split(' ')
              .join('-')
          ...
          <meta
            property="og:url"
            content={`https://www.ayazona.com/pickup/${city.toLocaleLowerCase()}/${location
              .split(' ')
              .join('-')
              .toLocaleLowerCase()}/${cuisine
              .toLocaleLowerCase()
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify(
                getCommonJsonld(
                  jsonldUrl ||
                    `https://www.ayazona.com/pickup/${city.toLocaleLowerCase()}/${location
                      .toLocaleLowerCase()
                      .split(' ')
                      .join('-')}/${cuisine
                      .toLocaleLowerCase()

    ...
    <ThemeProvider theme={appTheme}>
      <>
        <Head>
          ...
          <meta
            name="description"
            content={`Pre-order dine-in at affordable ${cuisine} restaurants in ${city} right to your doorstep. Ayazona is the app that delivers affordable food in minutes.`}
          />
          <link
            rel="canonical"
            href={`https://www.ayazona.com/dine-in/${city.toLocaleLowerCase()}/${cuisine
              .toLocaleLowerCase()
              .split(' ')
              .join('-')}`}
          />
          ...
          <meta
            property="og:url"
            content={`https://www.ayazona.com/dine-in/${city.toLocaleLowerCase()}/${cuisine
              .toLocaleLowerCase()
              .split(' ')
              .join('-')}`}
          />
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify(
                getCommonJsonld(
                  jsonldUrl ||
                    `https://www.ayazona.com/dine-in/${city.toLocaleLowerCase()}/${cuisine
                      .toLocaleLowerCase()
                      .split(' ')
                      .join('-')}`,

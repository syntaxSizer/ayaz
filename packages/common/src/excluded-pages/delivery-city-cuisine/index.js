  ...
  const links = [
    ...
    },
    {
      href: `/delivery/${city
        ...
        .join('-')}`,
      itemtype: 'http://schema.org/ListItem',
      name: `${cuisine.toLocaleLowerCase()}`,
      itemprop: 'name',
      position: 4,
    },
  ];
    ...
    <ThemeProvider theme={appTheme}>
      <>
        <Head>
          ...
          <meta
            name="description"
            content={`Get affordable ${cuisine} delivered from your favorite restaurants in ${city} right to your doorstep. Ayazona is the app that delivers affordable food in minutes.`}
          />
          <link
            rel="canonical"
            href={`https://www.ayazona.com/delivery/${city.toLocaleLowerCase()}/${cuisine
              .toLocaleLowerCase()
              .split(' ')
              .join('-')}`}
          />
          ...
          <meta
            property="og:url"
            content={`https://www.ayazona.com/delivery/${city.toLocaleLowerCase()}/${cuisine
              .toLocaleLowerCase()
              .split(' ')
              .join('-')}`}
          />
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify(
                getCommonJsonld(
                  jsonldUrl ||
                    `https://www.ayazona.com/delivery/${city.toLocaleLowerCase()}/${cuisine
                      .toLocaleLowerCase()
                      .split(' ')
                      .join('-')}`,
        ...
        <AppWrapper>
          ...
          <SubPageWrapper>
            ...
            />
            <Footer
              title={`${cuisine} delivery in ${city.split('-').join(' ')}`}

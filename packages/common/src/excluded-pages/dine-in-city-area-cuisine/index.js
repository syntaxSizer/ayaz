...
import Banner from 'common/src/containers/cuisines/cuisine-components/DineInBanner';
    ...
    <ThemeProvider theme={appTheme}>
      <>
        <Head>
          ...
          <meta
            name="description"
            content={`Get affordable ${cuisine} takeout from your favorite restaurants in ${location} right to your doorstep. Ayazona is the app that delivers affordable food in minutes.`}
          />
          <link
            rel="canonical"
            href={`https://www.ayazona.com/dine-in/${city.toLocaleLowerCase()}/${location
              .split(' ')
              .join('-')
          ...
          <meta
            property="og:url"
            content={`https://www.ayazona.com/dine-in/${city.toLocaleLowerCase()}/${location
              .split(' ')
              .join('-')
              .toLocaleLowerCase()}/${cuisine
              .toLocaleLowerCase()
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify(
                getCommonJsonld(
                  jsonldUrl ||
                    `https://www.ayazona.com/dine-in/${city.toLocaleLowerCase()}/${location
                      .toLocaleLowerCase()
                      .split(' ')
                      .join('-')}/${cuisine
                      .toLocaleLowerCase()
        ...
        <AppWrapper>
          ...
          <SubPageWrapper>
            ...
            <LocationDescription
              header={`${location
                .split('-')
                .join(' ')} affordable local food for takeout.`}
            ...
            />
            <DineInFooter
              title={`Order ${cuisine.toLocaleLowerCase()} takeaway in ${location
                .split('-')
                .join(' ')}`}

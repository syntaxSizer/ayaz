...
import FeatureSection from 'common/src/containers/privacy-and-terms/FeatureSection/privacy';
import { DrawerProvider } from 'common/src/contexts/DrawerContext';
import { getPrivacyPageSchema } from 'common/src/utils';
...
const Privacy = () => {
  return (
    <ThemeProvider theme={appTheme}>
      <>
        <Head>
          <title>Privacy policy • Ayazona</title>
          <meta
            name="description"
            content="At Ayazona, your privacy is important to us. In this Privacy Policy, we tell you what information we collect, share with others, and how we use it."
          />
          <link rel="canonical" href="https://www.ayazona.com/privacy" />
          <meta name="title" content="Privacy policy • Ayazona" />
          <meta property="og:title" content="Privacy policy • Ayazona" />
          <meta
            property="og:image"
          ...
          <meta property="og:url" content="https://www.ayazona.com/privacy" />
          <meta property="og:type" content="website" />
          <meta
            property="og:description"
            content="At Ayazona, your privacy is important to us. In this Privacy Policy, we tell you what information we collect, share with others, and how we use it."
          />
          <meta name="twitter:title" content="Privacy policy • Ayazona" />
          <meta
          ...
          <meta name="twitter:url" content="https://www.ayazona.com/privacy" />
          <meta name="theme-color" content="#fff" />
          <script
            key={'privacy-page-index'}
            type="application/ld+json"
            dangerouslySetInnerHTML={{
              __html: JSON.stringify(getPrivacyPageSchema()),
            }}
          />
        </Head>

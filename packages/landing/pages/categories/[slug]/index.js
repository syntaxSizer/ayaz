...
const Essentials = ({ aisle }) => {
  ...
  return (
    <ThemeProvider theme={appTheme}>
      <>
        <Head>
          <title>{`${Aisle ? Aisle.name : "Ayazona"} Products Delivery Services Near Me`}</title>
          ...
          />
          <link rel="canonical" href={`https://www.ayazona.com/categories/${Aisle.slug}`} />
          <meta
            name="title"
            content={`${
              Aisle ? Aisle.name : "Ayazona"
            } Products Delivery Services Near Me`}
          />
          <meta
            property="og:title"
            content={`${
          ...
          <meta
            property="og:url"
            content={`https://www.ayazona.com/categories/${Aisle.slug}`}
          />
        ...
        <AppWrapper>
          ...
          <CategoriesBanner title={Aisle.name} />
          <FeatureSection
            menu={AisleList}
            url={`/categories/${Aisle.slug}/aisle`}
            currency={Currency}
            aisle={Aisle}
          />

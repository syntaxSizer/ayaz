...
import { getEssentialsAislePageSchema } from "common/src/utils";
    ...
    <ThemeProvider theme={appTheme}>
      <>
        <Head>
          ...
          />
          <link rel="canonical" href={`https://www.ayazona.com/essentials/aisles/${id}`} />
          ...
          <meta property="og:url" content={`https://www.ayazona.com/essentials/aisles/${id}`} />
          ...
          <meta name="twitter:url" content={`https://www.ayazona.com/essentials/aisles/${id}`} />
          <meta name="theme-color" content="#fff"/>
          <script
			      key={`aisles-tag-${id}`}
			      type="application/ld+json"
			      dangerouslySetInnerHTML={{ __html: JSON.stringify(getEssentialsAislePageSchema(id, title.replace(/&amp;/g, "&")))}}
		      />
        </Head>

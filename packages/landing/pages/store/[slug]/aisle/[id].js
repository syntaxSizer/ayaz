...
const Aisle = ({items, title, aisle, id}) => {
  ...
  return (
    <ThemeProvider theme={appTheme}>
      <>
        <Head>
          <title>{`${title.replace(/&amp;/g, "&")} Products Delivery or Pickup Near Me • Ayazona`}</title>
          ...
          />
          <link rel="canonical" href={`https://www.ayazona.com/store/${Aisle.slug}/aisle/${id}`} />
          <meta name="title" content={`${title.replace(/&amp;/g, "&")} Products Delivery or Pickup Near Me • Ayazona`} />
          <meta property="og:title" content={`${title.replace(/&amp;/g, "&")} Products Delivery or Pickup Near Me • Ayazona`} />
          <meta property="og:image" content="/static/scripts/open_graph_logo.jpg" />
          <meta property="og:image:width" content="1200" />
          <meta property="og:image:height" content="628" />
          <meta property="og:url" content={`https://www.ayazona.com/store/${Aisle.slug}/aisle/${id}`} />
          ...
          <meta name="twitter:title" content={`${title} Products Delivery or Pickup Near Me • Ayazona`} />
          ...
          <meta name="twitter:url" content={`https://www.ayazona.com/store/${Aisle.slug}/aisle/${id}`} />
        ...
        <AppWrapper>
          ...
          <Sticky
            ...
            innerZ={9}
            activeClass="sticky-nav-active">
            <SubMenu onlyCartButton={true} location={AisleLocation}/>
          </Sticky>
          <StoreBanner title={''} />
